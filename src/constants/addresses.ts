...
export const V3_CORE_FACTORY_ADDRESSES: AddressMap = {
  ...
  [SupportedChainId.EIGEN]: EIGEN_V3_CORE_FACTORY_ADDRESSES,
...
export const V3_ROUTER_ADDRESS: AddressMap = {
  ...
  [SupportedChainId.EIGEN]: EIGEN_V3_ROUTER_ADDRESS,
...
export const V3_MIGRATOR_ADDRESSES: AddressMap = {
  ...
  [SupportedChainId.EIGEN]: EIGEN_V3_MIGRATOR_ADDRESSES,
...
export const MULTICALL_ADDRESS: AddressMap = {
  ...
  [SupportedChainId.EIGEN]: EIGEN_MULTICALL_ADDRESS,
...
export const QUOTER_ADDRESSES: AddressMap = {
  ...
  [SupportedChainId.EIGEN]: EIGEN_QUOTER_ADDRESSES,
...
export const NONFUNGIBLE_POSITION_MANAGER_ADDRESSES: AddressMap = {
  ...
  [SupportedChainId.EIGEN]: EIGEN_NONFUNGIBLE_POSITION_MANAGER_ADDRESSES,
...
export const TICK_LENS_ADDRESSES: AddressMap = {
  ...
  [SupportedChainId.EIGEN]: EIGEN_TICK_LENS_ADDRESSES,
